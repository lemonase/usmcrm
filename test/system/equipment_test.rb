...
class EquipmentTest < ApplicationSystemTestCase
  ...
  test "should create equipment" do
    ...
    fill_in "Condition", with: @equipment.condition
    ...
    fill_in "Note", with: @equipment.note
    fill_in "Price", with: @equipment.price
    fill_in "Serial", with: @equipment.serial
    fill_in "Warranty expiration", with: @equipment.warranty_expiration
